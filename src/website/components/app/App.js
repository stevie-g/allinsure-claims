    ...
    useEffect(() => {
        const initialiseDatabase = () => {
            ...
            dbresult.transaction((q) => {
                ...
                q.executeSql('INSERT INTO CUSTOMER VALUES ("001", "ms802", "Meg", "Sloan", "password", "22436687", "42 Northfields Avenue", "meg@gmail.com");')
            ...
            dbresult.transaction((q) => {
                q.executeSql('CREATE TABLE IF NOT EXISTS CLAIM (ID unique, type, user_ID, staff_ID, submit_date, status, staff_feedback, incident_type, incident_date, police_report, cost, description, driver_surname, driver_firstname, driver_licence_number, driver_dob, otherdriver_surname, otherdriver_firstname, otherdriver_licence_number, otherdriver_licence_plate, otherdriver_insurance, damage_location, contents_list);')
                q.executeSql('INSERT INTO CLAIM VALUES ("C0000001", "Car", "001", "001", "20/10/2019", "Pending", "Please provide police report ID", "", "15/10/19", "", "", "side-swiped at the traffic lights", "Meg", "Sloan", "9995551", "1/1/2000", "Jackson", "Mike", "", "CBU329", "NRMA", "", "");')
                q.executeSql('INSERT INTO CLAIM VALUES ("H0000002", "Home", "001", "002", "30/10/2018", "Resolved", "", "Burglary", "28/10/2018", "ADBUDFI3238GFH09", "3000", "My computer was stolen", "", "", "", "", "", "", "", "", "", "", "Laptop");')
                q.executeSql('INSERT INTO CLAIM VALUES ("C0000003", "Car", "002", "001", "14/10/2019", "Pending", "Please provide other driver\'s licence number", "", "7/10/19", "DDFRH4386B0001", "", "He reversed into my car at Woolies", "Sherman", "P", "9995551", "3/5/1980", "Smith", "Will", "", "GEF574", "AAMI", "", "");')
                q.executeSql('INSERT INTO CLAIM VALUES ("H0000004", "Home", "002", "002", "29/09/2019", "Approved", "", "Bushfire", "15/09/2019", "SDBWEDJH542H70001", "7000", "Shed was destroyed in the fire", "", "", "", "", "", "", "", "", "", "shed", "Lawn mower, pool table");')
            })
            updateDb(dbresult)
        }
        initialiseDatabase()
